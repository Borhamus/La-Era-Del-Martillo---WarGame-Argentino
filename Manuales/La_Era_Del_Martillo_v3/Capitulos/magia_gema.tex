...
\begin{enumerate}
    ...
    \item \textbf{Penalizador adicional:} Las unidades que terminen su movimiento en una Zona Seca sufren $-1$ a todas las tiradas hasta el final de la partida, esto se puede apilar hasta -4.
\end{enumerate}
\end{reglaespecial}
